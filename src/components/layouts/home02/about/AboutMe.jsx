            ...
            <div className="col-lg-7 animate-element wow delay5 fadeInDown" data-wow-delay="0.5s">
                <div className="flat-title t1">
                    ...
                    <div className="description">
                        ...
                        <p className="lt-sp01">
                        Even Adept at monitoring & maintaining frontend performance and troubleshooting & debugging the same to bolster overall performance.
                        </p>
                    </div>
                    <h3 className="email position-relative">sayyedeman59@gmail.com</h3>
                </div>
            </div>
        );
    }
