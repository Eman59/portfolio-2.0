                    ...
                    <div className="featured-post-right">
                        <div className="content-text">
                            <div className="animate-element wow delay5 fadeInDown" data-wow-delay="0.3s">
                                <div className="tag lt-sp53 mg-b24 text-white">Software Engineer</div>
                                <h1 className="cd-headline clip is-full-width title mg-b29 text-white">
                                    <span>Hello, </span>
                                    <span className="cd-words-wrapper color-d4">
                                        <b className="is-visible">I’m Imran!</b>
                                        {/* <b>Imran Sayyed!</b> */}
                                        {/* <b>I’m Amelia!</b> */}
                                    </span>
                                </h1>
                                <p className="mg-b53 text-white">
                                    Proficient in translating designs & wireframes into high-quality code, and writing application interface <br/> code via Javascript and ReactJS workflows.
                                </p>
                            </div>
