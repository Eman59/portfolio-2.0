            ...
            card: [
                {
                    ...
                    alt: 'images',
                    title: 'Web UI Design',
                    text: "I'm a professional Software Developer with 2 years of exp. My main focus is on listening."
                },
                {
                    id: 2,
                    ...
                    text: "I can create Mobile apps using Native frameworks for both android & ios using React Native."
                },
                {
                    id: 3,
                    classcard: "iconbox-s2 iconbox-s2-t1 bg-white",
                    ...
                    text: "I have mastered Javascript, ReactJs & Next Js to create fastest running webpages on internet."
                }
            ]
        }
    }
